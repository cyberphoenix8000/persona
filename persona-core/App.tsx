...
import { getPersonalityAnalysisAlgorithmic, getDynamicDeepDive } from './services/personalityAlgorithm';
...
const App: React.FC = () => {
  ...
  // Unified scroll manager for production navigation
  useEffect(() => {
    if (step !== 'intro') {
